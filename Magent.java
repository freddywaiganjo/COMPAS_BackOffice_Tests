...
public class Magent {
  ...
  @Test
  public void testMagent() throws Exception {
    ...
    driver.findElement(By.id("inpAgentDesc")).sendKeys("Hassan Hussein");
    ...
    driver.findElement(By.id("inpAgentCode")).sendKeys("agn4");
    driver.findElement(By.id("inpAgentDesc")).clear();
    driver.findElement(By.id("inpAgentDesc")).sendKeys("alex agt");
    driver.findElement(By.id("active")).click();
    driver.findElement(By.xpath("(//button[@type='button'])[12]")).click();
