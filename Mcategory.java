...
public class Mcategory {
  ...
  @Test
  public void testMcategory() throws Exception {
    ...
    driver.findElement(By.id("inpMerchantName")).sendKeys("ctg5");
    driver.findElement(By.xpath("(//input[@id='inpMerchantName'])[2]")).clear();
    driver.findElement(By.xpath("(//input[@id='inpMerchantName'])[2]")).sendKeys("alex categ");
    driver.findElement(By.id("active")).click();
    driver.findElement(By.xpath("(//button[@type='button'])[12]")).click();
