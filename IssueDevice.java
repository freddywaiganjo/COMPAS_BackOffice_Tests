...
public class IssueDevice {
  ...
  @Test
  public void testIssueDevice() throws Exception {
    ...
    driver.findElement(By.xpath("//ul[@id='nav']/li[5]/ul/li[2]/a/span")).click();
    driver.findElement(By.xpath("(//button[@type='button'])[2]")).click();
    driver.findElement(By.xpath("(//input[@name='radio1'])[2]")).click();
    driver.findElement(By.xpath("//section[@id='content']/div/form[2]/section/div[2]/div[5]/div/label[2]/span")).click();
