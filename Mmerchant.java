...
public class Mmerchant {
  ...
  @Test
  public void testMmerchant() throws Exception {
    ...
    driver.findElement(By.xpath("(//input[@id='inpMerchantName'])[2]")).sendKeys("KRCS 2");
    driver.findElement(By.id("active")).click();
    driver.findElement(By.xpath("(//button[@type='button'])[6]")).click();
    driver.findElement(By.xpath("//button[@type='button']")).click();
    driver.findElement(By.id("inpMerchantName")).clear();
    driver.findElement(By.id("inpMerchantName")).sendKeys("mc04");
    driver.findElement(By.xpath("(//input[@id='inpMerchantName'])[2]")).clear();
